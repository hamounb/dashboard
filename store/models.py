...
#     code = models.CharField(verbose_name="کد مشتری", max_length=12)
#     name = models.CharField(verbose_name="نام و نام خانوادگی", max_length=250)
...
#     code = models.CharField(verbose_name="کد محصول", max_length=12)
#     name = models.CharField(verbose_name="نام محصول", max_length=250)
